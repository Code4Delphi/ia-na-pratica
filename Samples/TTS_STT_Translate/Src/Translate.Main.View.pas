...
type
  TTranslateMainView = class(TForm)
    pnTop: TPanel;
    pnButtonsTop: TPanel;
...
var
  TranslateMainView: TTranslateMainView;

implementation

{$R *.dfm}

procedure TTranslateMainView.FormCreate(Sender: TObject);
begin
...
procedure TTranslateMainView.FormDestroy(Sender: TObject);
begin
  FAudioRecorder.Free;
end;

procedure TTranslateMainView.ScreenRecordingOn;
begin
...
procedure TTranslateMainView.ScreenRecordingOff;
begin
...
procedure TTranslateMainView.ClearResponse;
begin
...
function TTranslateMainView.GetLanguage: string;
begin
  Result := '';
...
procedure TTranslateMainView.btnStartRecordingClick(Sender: TObject);
begin
...
procedure TTranslateMainView.btnStopRecordingClick(Sender: TObject);
var
...
procedure TTranslateMainView.btnStopTalkingClick(Sender: TObject);
begin
